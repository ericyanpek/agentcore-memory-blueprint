...
> 本文档为 [英文原版](architecture.md) 的中文翻译。如有出入，以英文版为准。
...
Knowledge Base 是面向权威文档的检索机制；Skills 是带版本管理的运行行为。共享记忆
填补的是中间地带：那些有价值、已审核，但尚未沉淀为文档或 Skill 的经验。
...
晋升不是把原始对话复制一份，而是创建一个新的、有明确归属的制品，并附带来源引用、
审核人、生效日期和生命周期。
